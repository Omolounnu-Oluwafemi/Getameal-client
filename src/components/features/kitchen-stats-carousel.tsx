...
export function KitchenStatsCarousel({
  ...
  return (
    <div className="mb-4 pb-1">
      {/* Links to the reviews page — the card is the natural entry point. */}
      <Link
        href={`/${kitchenId}/reviews`}
        aria-label="See reviews"
        className="flex h-21 w-full items-center rounded-2xl border border-[#EDEDED] bg-white px-4 text-center shadow-[0px_4px_20px_0px_#0000000D] transition-colors hover:bg-neutral-50"
      >
