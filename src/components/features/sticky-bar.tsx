...
export function StickyBar({ amount, caption, actionLabel, onAction }: StickyBarProps) {
  return (
    <div className="fixed inset-x-0 -bottom-5 z-30 flex items-center justify-between gap-2.5 rounded-t-[20px] bg-[#FFFFFFE5] px-5 pt-5 pb-[max(2.5rem,calc(env(safe-area-inset-bottom)+1rem))] shadow-[0px_4px_40px_0px_#0000001A] backdrop-blur-[20px]">
      <div>
